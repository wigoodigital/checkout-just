  ...
  return (
      ...
      <GridContainer className={classes.content} justify="center" >        
        <GridItem xs={12} sm={12} md={12}>
          ...
          >
           <GridContainer justify='left' style={{marginBottom:'30px',}}>
              ...
              <GridItem xs={12} sm={12} md={12}>
                  <GridContainer justify='center'>
                      ...
                      <GridItem xs={12} sm={12} md={12} style={{ maxWidth: "850px" }}>
                        <GridContainer justify="center">
                      ...
                      <rect width="30.7987" height="31" fill={firstCardTextColor} transform="matrix(-1 0 0 1 30.7988 0)"/>
                          ...
                          <GridItem xs={12} sm={12} md={4} align='center' justify='center'>
