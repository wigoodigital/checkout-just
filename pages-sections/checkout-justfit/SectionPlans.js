          ...
          >
           ...
           <GridItem style={{marginBottom:'30px'}} xs={12} sm={12} md={10} >
             <PlanHorizontal theme='dark' plano='FIT+' >
               <GridContainer align='center' justify='center' style={{minHeight:'150px'}} onClick={()=>{setColor("#D3D3D3");setTextColor('#CCDA01');setTextPlano('FIT')}}>
               <GridItem xs={12} sm={12} md={1} justify='center' align='left'>
                 ...
                 <h5 className={classes.textDefault}>R$ 39,90</h5> 
                 </GridItem>
                 <GridItem xs={12} sm={12} md={4} justify='center' align='center'>
                 <h5 className={classes.textDefault}>Manutenção Anual</h5>
                 <h5 className={classes.textDefault}>R$ 149,90 em 5x de R$ 29,98</h5> 
                 </GridItem>
                 <GridItem xs={12} sm={12} md={2} justify='center' align='left'>
             
                    <h5 style={{fontSize:'13px',fontWeight:'700',padding:0, margin:0, textDecoration: 'line-through'}}>De R$ 79,90</h5>
                    <h5 style={{fontSize:'13px',fontWeight:'700',padding:0, margin:0,}}>Por R$</h5>
             
                 </GridItem>
                 <GridItem xs={12} sm={12} md={1} style={{margin:0,padding:0,}}>
            
                   <h1 style={{margin:0,padding:0,position:'relative',right:'90%',top:'10px',fontWeight:700,fontSize:'50px'}}>39<span style={{fontSize:'25px'}}>,90</span></h1>
                 </GridItem>
             ...
             <PlanHorizontal theme='whitePlan' style={{}} plano='FIT+'>
               <GridContainer align='center' justify='center' style={{minHeight:'150px'}}  onClick={()=>{setColor("#CCDA01");setTextColor('#D3D3D3');setTextPlano('JUST')}}>
               <GridItem xs={12} sm={12} md={1} justify='center' align='left'>
                 ...
                 <h5 style={{fontSize:'15px',fontWeight:'500',padding:0, margin:0,}}>R$ 149,90 em 5x de R$ 29,98</h5> 
                 </GridItem>
                 <GridItem xs={12} sm={12} md={2} justify='center' align='left'>
             
                    <h5 style={{fontSize:'13px',fontWeight:'700',padding:0, margin:0,textDecoration: 'line-through'}} align='left'>De R$ 79,90</h5>
                    <h5 style={{fontSize:'13px',fontWeight:'700',padding:0, margin:0,}}>Por R$</h5>
             ...
             <GridItem xs={12} sm={12} md={10} style={{marginTop:'20px'}} align='left'>
               ...
               <GridItem>
                 ...
                 <GridItem xs={12} sm={12} md={1} align='center' justify='center' style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                  <input type='checkbox' style={{width:'20px', height:'20px', backgroundColor:'#D8D8D8', border:0,borderRadius:'3px'}}></input>
                  </GridItem>
