      ...
      <GridContainer className={classes.content} justify="center"  >        
        <GridItem xs={12} sm={12} md={12}>
          ...
          >
           ...
           <h2 style={{marginBottom:'40px', marginTop:'20px', fontSize: '25px', fontWeight:'400',color:'#787878'}}>SEJA <strong style={{fontWeight:'700',color:'#484848',}}>BEM VINDO(A)</strong> À JUSTFIT, <strong style={{fontWeight:'900',color:'#484848'}}>JOSÉ</strong> </h2>
           </GridItem>
              <GridItem xs={12} sm={12} md={10}>
