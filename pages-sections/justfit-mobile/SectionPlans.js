          ...
          >
           ...
           <GridItem className={classes.stepMobile} xs={6} sm={6} md={4}  align='right'>
             ...
             <GridItem xs={12} sm={12} md={12} style={{marginTop:'20px'}} align='left'>
               ...
               <input type='checkbox' style={{width:'20px', height:'20px', backgroundColor:'#D8D8D8', border:0,borderRadius:'3px',marginLeft:'10px',marginRight:'10px'}}></input>
               <div className={classes.planoAdicionalContent} style={{marginTop:20,marginBottom:20,}}>
               <h5 style={{fontWeight:700,}}>JUSTFIT PROFISSIONAL ONLINE</h5>
                   <p>Aliquam erat volutpat. Suspendisse purus dui, </p>
