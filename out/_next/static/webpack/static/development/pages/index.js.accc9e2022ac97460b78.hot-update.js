...
function SectionPlans(props) {
  ...
  var formatValueDesc = function formatValueDesc(value) {
    var decimalValue = new String(value.toFixed(2)).replace(".", ",");
    return __jsx("h1", {
      style: {
        margin: 0,
        padding: 0,
    ...
    }, decimalValue.substr(2), __jsx("span", {
      style: {
        fontSize: '25px'
      },
      __self: _this,
  ...
  }, "R$ ", formatValue(props.plans[0].valorAnuidade), " em ", props.plans[0].parcelasAnuidade.length, "x de ", props.plans[0].parcelasAnuidade[0].valorApresentar)), __jsx(components_Grid_GridItem_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
    xs: 12,
    sm: 12,
    md: 2,
    justify: "center",
  ...
  }, "De R$ ", formatValue(props.plans[0].valorMensal)), __jsx("h5", {
    style: {
      fontSize: '13px',
      fontWeight: '700',
      padding: 0,
  ...
  }, formatValueDesc(props.plans[0].parcelas[0].valor)))))), __jsx(components_Grid_GridItem_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
    xs: 12,
    sm: 12,
    md: 10,
    __self: this,
...
//# sourceMappingURL=index.js.accc9e2022ac97460b78.hot-update.js.map