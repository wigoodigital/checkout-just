...
function SectionPlans(props) {
  ...
  return __jsx(components_Grid_GridContainer_js__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    if (plan.descricao.includes("FIT")) {
      ...
      }, "R$ ", formatValue(plan.valorAnuidade), " em ", plan.parcelasAnuidade.length, "x de ", plan.parcelasAnuidade[0].valorApresentar)), __jsx(components_Grid_GridItem_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
        xs: 12,
        sm: 12,
        md: 2,
        justify: "center",
...
//# sourceMappingURL=index.js.ea2ed19d69dfcc81c005.hot-update.js.map