...
function CustomizedSteppers() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_32___default.a, {
    ...
    if (i < plans[activePlan].parcelasAnuidade.length) {
      console.log(plans[activePlan].parcelasAnuidade[i].valorApresentar);
    }
    ...
    }, parcela.numero, "\xAA Cobran\xE7a"), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_31__["default"], {
    ...
    }, "Taxa de manuten\xE7\xE3o"), plans[activePlan].parcelasAnuidade.length < i ? __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_31__["default"], {
      className: classes.secondaryHeading2,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.bb886635755558904ab5.hot-update.js.map