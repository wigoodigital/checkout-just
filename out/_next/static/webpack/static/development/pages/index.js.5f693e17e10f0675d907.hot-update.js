...
function CustomizedSteppers() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_32___default.a, {
    ...
    }, " R$ ", new String(formatValueParcela(plans[activePlan].parcelasAnuidade[i].valor) + formatValueParcela(parcela.valor)).replace(".", ","), " ") : __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_31__["default"], {
      className: classes.secondaryHeading,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.5f693e17e10f0675d907.hot-update.js.map