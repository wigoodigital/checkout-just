...
function SectionPayment(props) {
  ...
  var validateForm = function validateForm() {
    var validationForms, validationCobranca, identificationForm, identificationCredit, identificationDebit;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function validateForm$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            validationCobranca = _context2.sent;
          ...
          case 7:
            validationForms = _context2.sent;
            ...
            props.setDataSale(function (prevDataSale) {
              return {
                customer: _objectSpread({}, prevDataSale.customer, {
                  ...
                  address: {
                    address: identificationCredit.endereco,
                    number: identificationCredit.numero,
                    complement: identificationCredit.complemento,
                    district: identificationCredit.bairro,
                    city: identificationCredit.cidade,
                    state: identificationCredit.estado,
                    postalCode: identificationCredit.cep.replace(/[^\d]+/g, '')
                  },
                  card: {
                    number: identificationCredit.number,
                    name: identificationCredit.nameCredit,
                    valid: identificationCredit.valid,
                    cvv: identificationCredit.cvv,
                    bandeira: identificationCredit.cvv
                  }
                })
              };
            });
...
//# sourceMappingURL=checkout.js.52de216845bb7b93f052.hot-update.js.map