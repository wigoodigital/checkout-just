...
function CustomizedSteppers() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_32___default.a, {
    ...
    }, parcela.numero, "\xAA Cobran\xE7a"), i < plans[activePlan].parcelasAnuidade.length ? __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_31__["default"], {
    ...
    }, "  ", formatValueParcela(plans[activePlan].parcelasAnuidade[i].valorApresentar) + formatValueParcela(parcela.valor), " ") : __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_31__["default"], {
      className: classes.secondaryHeading,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }, " ", parcela.valor, " ")), __jsx(_material_ui_core_ExpansionPanelDetails__WEBPACK_IMPORTED_MODULE_24__["default"], {
      style: {
        display: 'flex',
        flexDirection: 'column'
      },
...
//# sourceMappingURL=index.js.f09e2c7b540bad358ce4.hot-update.js.map